...
var grammar = {
    ...
    {"name": "cmp", "symbols": ["operand", "_", "GTE", "_", "operand"], "postprocess": ([left,, op,, right]) => ({ left, op: "GTE", right })},
    {"name": "cmp", "symbols": ["operand", "_", "LTE", "_", "operand"], "postprocess": ([left,, op,, right]) => ({ left, op: "LTE", right })},
    ...
    {"name": "dictLiteral", "symbols": ["LBRACE", "___", "dictBody", "___", "RBRACE"], "postprocess": ([,,entries]) => ({ type: "DICTIONARY", entries })},
